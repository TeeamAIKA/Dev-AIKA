...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source TeamAIKA - اهلا بك في سورس ديف الكا ~"
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (HMD) @itsPsychopathy.|"
echo -e "|  This Is The Source Channel @AikaTeam .   |"
echo -e "|               - TeamAIKA -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
